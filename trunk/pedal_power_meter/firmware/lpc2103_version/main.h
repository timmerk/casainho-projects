...
#define MENU_SHOW_USER_TIME 0
#define MENU_SHOW_USER_POWER 1
#define MENU_SHOW_SYSTEM_POWER 2
#define MENU_SHOW_VOLTAGE_CURRENT 3
#define MENU_SHOW_ADC_READINGS 4
