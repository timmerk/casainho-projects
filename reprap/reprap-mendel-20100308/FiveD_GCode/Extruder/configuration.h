...
//our RS485 phttp://focus.ti.com/general/docs/lit/getliterature.tsp?genericPartNumber=sn75176a&fileType=pdfins
...
// I2C pins for the MAX 6675 temperature chip
 #define SO 5    // MISO
 #define SCK 7   // Serial Clock
 #define TC_0 6  // CS Pin of MAX6607
#else
 #define TEMP_PIN 3
#endif
